...
const Project = () => {
  ...
  return (
    <div id='projects' className='p-10 h-screen flex flex-col justify-center items-center'>
      <h2 className='text-4xl font-bold text-center mb-20 bg-gradient-to-r from-blue-500 to-purple-500 text-transparent bg-clip-text'>My Creativity On Webdevelopment</h2>
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10'>
        {projects.map((project, index) => (
          <div key={index} className="border border-gray-300 rounded-lg p-5 shadow-lg">
            <img src={project.imageLink} alt={project.name} className="w-full h-48 object-cover rounded-lg" />
